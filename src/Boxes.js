      ...
      <View style={styles.container}>
          <View style={styles.box1}>
               <View style={styles.inner1}>
                   ...
                   <Text style={{color:'white' ,marginLeft:70, marginTop:-20}}>kg</Text>
               ...
               <View style={styles.inner2}>
                <Text style={{color:'white',fontSize:40}} >175</Text>
                   <Text style={{color:'white' ,marginLeft:90, marginTop:-20}}>kg</Text>
                   <Text style={{color:'white',marginTop:10}}>Weight</Text>
               ...
               <View style={styles.inner3}>
                ...
                <Text style={{color:'white',marginTop:10,marginLeft:-190}}>Experience</Text>
